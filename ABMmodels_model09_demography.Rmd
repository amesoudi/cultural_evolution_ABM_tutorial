...
$$ \bar z' = z_h + \Delta z_h                       \hspace{30 mm}(9.1)$$
...
$$ z_h = a + \beta (\epsilon + \ln(N))                       \hspace{30 mm}(9.2)$$
...
$$ \Delta z_h = a + \beta\epsilon - a - \alpha = -\alpha + \beta\epsilon   \hspace{30 mm}(9.3) $$
...
$$ \Delta \bar z = -\alpha + \beta (\epsilon + \ln(N))   \hspace{30 mm}(9.4) $$
...
$$ N^* = e^{(\frac{\alpha}{\beta} - \epsilon)}   \hspace{30 mm}(9.5)$$
